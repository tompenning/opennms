...
public class IfTttDaemonTest {
    ...
    public void setup() {
        ...
        addAlarm(12, 1, EventConstants.BUSINESS_SERVICE_PROBLEM_UEI, OnmsSeverity.MINOR);
        addAlarm(13, null, EventConstants.BUSINESS_SERVICE_PROBLEM_UEI, OnmsSeverity.CRITICAL);
        addAlarm(14, 3, EventConstants.BUSINESS_SERVICE_PROBLEM_UEI, OnmsSeverity.MAJOR);
    }
    ...
    public void ifTttDaemonTestFoo() throws Exception {
        ...
        Assert.assertEquals(new ResultEntry("MAJOR", "INDETERMINATE", 0, "MAJOR", 2), bsm1.get(1));
        Assert.assertEquals(new ResultEntry("MAJOR", "MAJOR", 2, "MAJOR", 3), bsm1.get(2));
